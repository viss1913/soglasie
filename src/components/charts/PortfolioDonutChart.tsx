...
const PortfolioDonutChart: React.FC<PortfolioDonutChartProps> = ({ items, total, title }) => {
        ...
        <div className="premium-card" style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                {items.length > 0 ? items.map((item, idx) => (
                    ...
                    <div style={{ color: '#94a3b8', textAlign: 'center', padding: '20px', fontSize: '13px' }}>Нет активов</div>
                )}
            </div>
